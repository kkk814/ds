...
# Step 2: Add a new student at the end of the list
...
# Step 3: Remove the first student from the list
students <- students[-1]
...
students[[length(students) - 1]] <- "Zara"  # Change the second last student's name
